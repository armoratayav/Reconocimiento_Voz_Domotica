...
from mapear_comando_ia import mapear_secuencial_a_arduino
from secuencial_gru_utils import CONFIDENCE_THRESHOLD, predict_audio
...
def main():
    if len(sys.argv) < 2:
        print("Uso:")
        print("python scripts/probar_modelo_secuencial_gru_con_arduino.py ruta_del_audio.wav")
        return
    ...
    arduino_command = mapear_secuencial_a_arduino(
        predicted_class,
        confidence,
